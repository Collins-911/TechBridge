  ...
  <Link to="/forgot-password" className="forgot-password">
    Forgot password?
          ...
          <div className="social-auth">
            <button type="button" className="social-button google" title="Sign in with Google" disabled={isLoading}>
              <span className="google-icon"><FcGoogle /></span>
            </button>
            <button type="button" className="social-button github" title="Sign in with GitHub" disabled={isLoading}>
              <FaGithub />
            </button>
          </div>
